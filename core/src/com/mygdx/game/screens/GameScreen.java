...
public class GameScreen implements Screen {
    ...
    public GameScreen(MyGame parent) {
        ...
        *  the systems like movement)*/
        ...
        enemy.add(new SizeComponent());
        enemy.add(new SpriteComponent());
        enemy.add(new IDComponent());
        SpriteComponent enemySprite = cg.getSprite(enemy);
...
//        player.movePlayer(gameMapProperties);
        Entity entity = parent.engine.getEntitiesFor(Family.all(PlayerComponent.class).get()).get(0);
